...
// var eleArray = document.getElementsByClassName('signature');
...
// Canvas fingerprinting by using color gradients and bezier curves
...
// These keys are directly fetched from the navigator object in the browser.
...
window.onload = function() {
    ...
    var data = {"navigator":navi_keys,'client_id':'MYP101010'};
    var request = new XMLHttpRequest();
    request.open('POST', 'https://wibmo-signature.pc.enstage-sas.com/posting_data', true);
    request.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
    request.send(JSON.stringify(data));
    var data = {'client_id':'MYP101010'};
    
    var request = new XMLHttpRequest();
    request.open('POST', '/analysis_data', true);
    request.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
    request.send(JSON.stringify(data));
};
